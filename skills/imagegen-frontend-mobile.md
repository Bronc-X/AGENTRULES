...
description: 为 iOS、Android 和跨端 App 生成高质移动界面参考图。
allowed-tools:
  - Read
  - Write
  - Edit
...
- generic palettes
- default purple-blue startup color clich茅s
...
- 1 screen 鈫?generate 1 screen image
- 2 screens 鈫?generate 2 screen images
- 3 screens 鈫?generate 3 screen images
- 5 screens 鈫?generate 5 screen images
- 7 screens 鈫?generate 7 screen images
- onboarding flow 鈫?generate multiple onboarding screens, not one
- auth flow 鈫?generate separate sign in / sign up / recovery states when useful
- app concept 鈫?generate a meaningful set, not one isolated hero mockup
...
Examples:
- onboarding 鈫?auth 鈫?home
- home 鈫?browse 鈫?detail
- profile 鈫?settings 鈫?edit profile
- cart 鈫?checkout 鈫?confirmation
- dashboard 鈫?activity 鈫?detail
- welcome 鈫?permissions 鈫?personalized home
