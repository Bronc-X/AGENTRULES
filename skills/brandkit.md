...
Allowed layouts:
- `3 脳 3` full identity system
- `2 脳 3` cinematic brand deck overview
- `2 脳 2` compact concept board
- `1 脳 3` horizontal brand strip
- `4 脳 2` wide contact-sheet layout
...
Examples:
- build 鈫?frame, scaffold, block, cursor
- protect 鈫?shield, boundary, watch mark
- convert 鈫?switch, arrow, transformation shape
- speak 鈫?waveform, mic, pulse
- hunt threats 鈫?eye, raptor, radar, trace
- automate 鈫?loop, handoff, path
...
Layout:
[3脳3 / 2脳3 / custom] grid on a dark or light presentation canvas with strong gutters, clean alignment, and refined negative space.
