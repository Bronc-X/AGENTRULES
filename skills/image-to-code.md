...
Interpretation:
- If the user says 鈥渃lean鈥? reduce density and increase clarity.
- If the user says 鈥渃razy creative鈥? increase variance and art direction.
- If the user says 鈥減remium SaaS鈥? keep clarity high and art direction controlled.
- If the user says 鈥渆ditorial鈥? allow stronger type and more asymmetry.
...
- rely on memory of 鈥済ood frontend taste鈥?instead of producing the actual reference
...
- 1 section requested 鈫?generate 1 image
- 2 sections requested 鈫?generate 2 images
- 3 sections requested 鈫?generate 3 images
- 4 sections requested 鈫?generate 4 images
- 5 sections requested 鈫?generate 5 images
- 6 sections requested 鈫?generate 6 images
- 7 sections requested 鈫?generate 7 images
- 8 sections requested 鈫?generate 8 images
- 9 sections requested 鈫?generate 9 images
- 10 sections requested 鈫?generate 10 images
...
- the hero headline should ideally stay within 1鈥? lines
...
- add unnecessary labels like 鈥?0 orchestration layer鈥?or similar pseudo-system text if it does not add real value
...
- a hero only 鈫?generate 1 hero image
- 4 sections 鈫?generate 4 section images
- 8 sections 鈫?generate 8 section images
- 12 sections 鈫?generate 12 section images when reasonable
...
Do not only notice that typography 鈥渓ooks nice鈥?
Analyze it properly.
...
Do not 鈥渋mprove鈥?the design by replacing it with a generic coded layout.
...
- do not remove the page鈥檚 visual identity for convenience
...
### Example 1
User:
鈥渕ake me one hero section for an AI startup鈥?
...
### Example 2
User:
鈥渄esign me an 8-section landing page鈥?
...
### Example 3
User:
鈥渕ake a premium creative agency website with 4 sections鈥?
